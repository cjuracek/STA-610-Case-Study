...
* dose_per_mg: Controlling for other variables, for every one milligram increase of dosage, the price per mg of oxymorphone increases by a multiplicative effect of exp(-0.01524395) = 0.9848717, about a 1.51% reduction.

* bulk_purchase: “Not bulk purchase” is the reference group.
  * Controlling for other variables, bulk purchase reduces the price per mg of oxymorphone by a multiplicative effect of exp(-0.17013501) = 0.8435509, about a 15.64% reduction.

* source: “Source: Unknown” is the reference group. 
  * Controlling for other variables, purchasing oxymorphone with Internet source tends to increase the price per mg by a multiplicative effect of exp(0.12686001) = 1.135258, about a 13.53% increase than the price per mg of oxymorphone for people with unknown drug source.
  * Controlling for other variables, purchasing oxymorphone with Internet Pharmacy source tends to increase the price per mg by a multiplicative effect of exp(-0.44349281) = 0.6417908, about a 35.82% reduction of the price per mg of oxymorphone for people with unknown drug source.
  * Controlling for other variables, purchasing oxymorphone with personal source tends to increase the price per mg by a multiplicative effect of exp(0.06140303) = 1.063327, about a 6.33% increase than the price per mg of oxymorphone for people with unknown drug source.
  * Controlling for other variables, purchasing oxymorphone with “heard it” source tends to increase the price per mg by a multiplicative effect of exp(0.18025958) = 1.197528, about a 19.75% increase than the price per mg of oxymorphone for people with unknown drug source.

#### Random Effects
```{r}
#VarCorr(mod1)
Variance <- c(0.0233, 0.5028)
Std.Dev <- c(0.1526, 0.7091)
...
```
The within-state variance $\sigma^2$ is 0.5028, which is much larger than the across-state variance $\tau^2$, 0.0233.
