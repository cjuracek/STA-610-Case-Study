...
* For the date_num variable, all else quals, for every one unit increase in the date_num, the price per mg of oxymorphone decreases to exp(-0.0001290) =  0.999871 times the original price.
* For the mgstr variable, controlling for for other variables, for every one unit increase in mgstr, the price per mg of oxymorphone decrease to exp(-0.0241262) =  0.9761625 times the original price.
